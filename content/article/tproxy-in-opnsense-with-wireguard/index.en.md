...
{{< alert >}}
**Note** Starting from 26.1, OPNsense migrated to a new unified MVC/API firewall rules interface — add rules directly under Firewall ‣ Rules and configure the corresponding fields. The following content applies to older versions of OPNsense.
{{< /alert >}}

{{< alert >}}
**Note** Starting from 26.7, Outbound NAT has been merged into the Source NAT page — add rules directly under Firewall ‣ NAT ‣ Source NAT and configure the corresponding fields. The following content applies to older versions of OPNsense.
{{< /alert >}}
